...
![Education Portal Folder Structure](image/File%20structure.png)

---

## 🚀 Getting Started
1. **Clone** this repository or download the ZIP file.
2. **Add your files:** Place any additional PDF papers into the `static/` folder.
...
1. **Upload:** Place your new PDF file into the `static/` folder.
2. **Register:** Open `app.js` and add a new entry to the `allPapers` array:
